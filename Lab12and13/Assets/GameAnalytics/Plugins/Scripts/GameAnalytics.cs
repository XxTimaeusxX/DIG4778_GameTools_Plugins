...
# endif
        ...
        /// <summary>
        /// Track a custom weather-related design event.
        /// </summary>
        /// <param name="eventName">Event name (e.g., "WeatherAction").</param>
        /// <param name="eventDescription">Description of the event (e.g., weather details).</param>
        public static void WeatherEvent(string eventName, string eventDescription)
        {
            if (!GameAnalytics._hasInitializeBeenCalled)
            {
                Debug.LogError("GameAnalytics: REMEMBER THE SDK NEEDS TO BE MANUALLY INITIALIZED NOW");
            ...
            // Log the event with the event name and description
            GA_Design.NewEvent(eventName + ": " + eventDescription, null, false);
